...
const Finder = (function Finder() {
	...
	VideoFinder.prototype.addListener = function addListener() {
	...
	VideoFinder.prototype.search = async function search(event, searchInput) {
	...
	VideoFinder.prototype.show = function show() {
